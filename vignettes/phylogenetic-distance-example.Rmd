...
vignette: >
  %\VignetteIndexEntry{Local Biplots for Simulated Data}
...
In this vignette, we demonstrate how to use the `localBiplots` package to make local biplots.
...
ggplot(sb_and_var_descriptions_wuf,
       aes(x = Embedding1, y = Embedding2,
           xend = 30 * Axis1 + Embedding1,
           yend = 30 * Axis2 + Embedding2,
           color = var_description)) +
    geom_segment() +
    geom_point(aes(shape = sample %in% group_a),
